                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
                        ...
                        <div class="px-6 py-5 space-y-5">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div><label for="shipping_postal_code" class="block text-sm font-medium text-gray-700">Postal code *</label><input id="shipping_postal_code" name="shipping_postal_code" value="{{ old('shipping_postal_code') }}" autocomplete="shipping postal-code" inputmode="numeric" pattern="[0-9]{4}" required minlength="4" maxlength="4" aria-describedby="shipping-postal-code-help" class="mt-1 w-full rounded-lg border-gray-300"><p id="shipping-postal-code-help" class="mt-1 text-sm text-gray-500">Enter four digits, including any leading zeros.</p></div>
                            </div>
                            <div>
