    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="md:flex">
            ...
            <div class="md:w-1/2 p-6">
                ...
                <div class="text-2xl font-bold text-gray-900 mb-4">{{ \App\Support\StoreMoney::format($product->price) }}</div>
        ...
        <div class="mb-8 border-b pb-8">
            ...
            <form action="{{ route('reviews.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="comments" name="comments" rows="4" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Share your experience with this product..." required></textarea>
                </div>
